...
final class LibHangulTests: XCTestCase {
    ...
    func testHangulComposition() {
        ...
        let galm = LibHangul.composeHangul(choseong: "ㄱ", jungseong: "ㅏ", jongseong: "ㄹㅁ")
    ...
    func testInputContextTextProcessing() {
        ...
        // 복잡한 입력
        let result4 = context.processText("안녕하세요")
        // 실제로는 각 자모가 개별적으로 처리되므로 정확한 결과는 다를 수 있음
    ...
    func testEdgeCases() {
        ...
        XCTAssertEqual(numberResult, "123")
